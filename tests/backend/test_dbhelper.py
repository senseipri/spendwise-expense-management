...
def test_fetch_expenses_for_date_aug_15():
    expenses = dbhelper.fetch_expenses_for_date("2024-08-15")
...
def test_fetch_expenses_for_date_invalid_date():
    expenses = dbhelper.fetch_expenses_for_date("9999-08-15")

    assert len(expenses) == 0


def test_fetch_expense_summary_invalid_range():
    summary = dbhelper.fetch_expense_summary("2099-01-01", "2099-12-31")
